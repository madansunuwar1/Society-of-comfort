  ...
  return (
    <div className="flex justify-center">
      <div className="px-5 pb-20 bg-white">
        <div className="bg-[#292963] rounded-lg px-4 py-4 mt-4">
          <div className="flex justify-between">
            <div className="flex gap-2">
              <TbCalendarDue className="h-10 w-10 my-auto text-white" />
              <div>
                <h1 className="text-sm font-bold text-white">Payment Due</h1>
                <div className="flex items-center gap-2">
                  <p className="text-sm text-white mt-1">
                    {showAmount ? "NPR. 1800.00" : "NPR. xxxx.xx"}
                  </p>
                </div>
              </div>
            </div>
            <div className="my-auto">
              <button onClick={toggleAmountVisibility} className="text-white">
                {showAmount ? (
                  <AiOutlineEyeInvisible className="h-7 w-7" />
                ) : (
        ...
        <div className="flex justify-between gap-4 mt-4">
          ...
          <Link to="/booking">
            <div className="w-[165px] h-[100px] rounded-lg bg-[#4a6e31] p-2 shadow-lg shadow-slate-400">
              ...
              <h1 className="text-[14px] font-bold font-roboto text-white">
                Booking
              </h1>
              <p className="text-[10px] font-roboto text-[#B5B5B5]">
