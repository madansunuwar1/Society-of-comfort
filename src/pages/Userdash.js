            ...
            <Link to="/payment">
              <div className="w-[165px] h-[100px] rounded-xl bg-[#752FFF] p-2 shadow-lg shadow-slate-400">
                ...
                <p className="text-[10px] font-roboto text-[#B5B5B5]">
                  See your payment info for this month
                </p>
              </div>
            </Link>
            <Link to="/notice">
              <div className="w-[165px] h-[100px] rounded-xl bg-[#F55A70] bg-opacity-20 p-2 shadow-lg shadow-slate-400">
                ...
                <p className="text-[10px] font-roboto text-[#C19595]">
                  Private and public notices can be seen here
                </p>
              </div>
            </Link>
          </div>
            ...
            <Link to="/service">
              <div className="w-[165px] h-[100px] rounded-xl bg-[#752FFF] bg-opacity-20 p-2 shadow-lg shadow-slate-400">
                ...
                <p className="text-[10px] font-roboto text-[#91ABDD]">
                  you can find services of the society
                </p>
              </div>
            </Link>
            <Link to="/history">
              <div className="w-[165px] h-[100px] rounded-xl bg-[#FFAE00] bg-opacity-20 p-2 shadow-lg shadow-slate-400">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_210_418)">
                    <path
                      d="M0.880688 3.97445L3.38663 6.48039C5.7171 3.42942 9.03831 1.28637 12.7785 0.420155C16.5187 -0.446061 20.4439 0.0187593 23.8783 1.7346C27.3128 3.45043 30.0416 6.30993 31.595 9.82082C33.1484 13.3317 33.4293 17.2743 32.3892 20.97C31.349 24.6656 29.0531 27.883 25.8965 30.0683C22.7399 32.2536 18.9203 33.2701 15.0951 32.9427C11.2698 32.6154 7.6784 30.9647 4.93902 28.2749C2.19964 25.585 0.483707 22.0243 0.0866258 18.2057C0.0445061 17.7974 0.166325 17.389 0.425283 17.0705C0.684242 16.752 1.05913 16.5494 1.46747 16.5072C1.87581 16.4651 2.28416 16.5869 2.60269 16.8459C2.92121 17.1048 3.12382 17.4797 3.16594 17.8881C3.49111 21.0074 4.89961 23.914 7.14636 26.1021C9.39311 28.2903 12.3359 29.6215 15.4627 29.8641C18.5896 30.1068 21.7025 29.2455 24.2599 27.4302C26.8173 25.6148 28.6574 22.9603 29.4599 19.9285C30.2624 16.8967 29.9765 13.6794 28.6521 10.8366C27.3277 7.99375 25.0485 5.70521 22.2111 4.36916C19.3737 3.03312 16.1576 2.73413 13.1226 3.52422C10.0875 4.31431 7.42548 6.14347 5.59969 8.69345L8.40056 11.4943C8.47286 11.5664 8.52212 11.6584 8.54209 11.7585C8.56206 11.8587 8.55185 11.9625 8.51275 12.0568C8.47365 12.1512 8.40741 12.2318 8.32245 12.2884C8.23749 12.3451 8.13762 12.3752 8.0355 12.375H0.515626C0.378874 12.375 0.247722 12.3207 0.151024 12.224C0.0543255 12.1273 8.25672e-07 11.9961 8.25672e-07 11.8594V4.33951C-0.000181876 4.2374 0.0299599 4.13753 0.086605 4.05256C0.14325 3.9676 0.223847 3.90137 0.318179 3.86227C0.412511 3.82316 0.516329 3.81295 0.616472 3.83292C0.716615 3.8529 0.808573 3.90215 0.880688 3.97445ZM15.9844 8.25001C16.3946 8.25001 16.7881 8.41299 17.0782 8.70308C17.3683 8.99318 17.5312 9.38663 17.5312 9.79689V15.9679L21.714 17.6426C22.0826 17.8033 22.3741 18.1012 22.5268 18.4732C22.6795 18.8452 22.6814 19.262 22.532 19.6353C22.3826 20.0086 22.0938 20.3091 21.7266 20.4731C21.3595 20.637 20.9429 20.6516 20.5652 20.5136L15.4089 18.4511C15.1223 18.336 14.8767 18.1378 14.7036 17.882C14.5305 17.6262 14.4379 17.3245 14.4375 17.0156V9.79689C14.4375 9.38663 14.6005 8.99318 14.8906 8.70308C15.1807 8.41299 15.5741 8.25001 15.9844 8.25001Z"
                      fill="#FFC545"
                    />
                  </g>
                  <defs>
                ...
                <p className="text-[10px] font-roboto text-[#ABA688]">
                  you can find your invitation and other history here
                </p>
              </div>
            </Link>
          </div> */}
